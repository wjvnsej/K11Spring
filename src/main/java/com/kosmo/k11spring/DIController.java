...
public class DIController {
	...
	public ModelAndView myAvengers() {
		...
		ApplicationContext이다. 다른말로는 IoC컨테이너, 스프링컨테이너 
		혹은 BeanFactory로 부르기도 한다.
	...
	public ModelAndView myAnnotation() {
		...
		//빈을 생성 할 JAVA파일을 가져와서 스프링 컨테이너를 생성함.
